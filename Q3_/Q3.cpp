...
int main()
{
    ...
    write_to_file(t_RK4,"Grid_Points_RK4_Solution.csv");
    ...
    for(int i= 0;i<Values_of_c.size();i++)
    {
        ...
        write_to_file(sol1_RK4,"RK4_1_Solution_c_"+to_string(c)+".csv");
        write_to_file(sol2_RK4,"RK4_2_Solution_c_"+to_string(c)+".csv");
    }
    return 0;
}
